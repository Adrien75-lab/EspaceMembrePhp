...
<div id="mail">
    ...
    <button class="btn btn-primary" id="btnModifMail"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
...
<div id="modificationMail" class="d-none">
    <form method="POST" action="<?= URL; ?>compte/validation_modificationMail">
        <div class="row">
            ...
            <div class="col-2">
                <button class="btn btn-success" id="btn ValidModifMail" type="submit">
